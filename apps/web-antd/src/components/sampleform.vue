...
<template>
  <Modal
    ...
    :confirm-loading="sampleStore.sampleCreateLoading"
    :ok-text="$t('create')"
    :title="$t('create')"
    centered
    width="800px"
      ...
      <div class="flex h-[200px] w-full">
        <div class="m-2 flex flex-1 rounded-lg bg-white shadow-md">
          ...
          <div class="relative w-[184px]">
            <Image
              :src="
                sampleStore.sampleCreate.product_image ??
          ...
          <div class="flex-1 pl-4">
            <!-- 商品标题 -->
            <Input
              v-model:value="sampleStore.sampleCreate.product_name"
            ...
            <div class="mt-2 flex items-center space-x-3 text-sm text-gray-500">
              <Input
                v-model:value="sampleStore.sampleCreate.product_id"
            ...
            <div class="mt-4 flex flex-row">
              <Input
                v-model:value="sampleStore.sampleCreate.product_final_price"
                :placeholder="$t('product_final_price')"
                class="mr-3 text-base leading-6 text-blue-600"
              />
              <Input
                v-model:value="sampleStore.sampleCreate.product_srp"
                :placeholder="$t('product_srp')"
                class="mr-3 text-sm leading-6 text-gray-400 line-through"
              />
              <Input
                v-model:value="sampleStore.sampleCreate.product_discount"
                :placeholder="$t('product_discount')"
                class="mr-3 text-sm leading-6 text-red-50"
              />
            </div>
          </div>
        </div>
