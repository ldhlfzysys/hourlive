        ...
        <div class="flex-1 pl-4">
          ...
          <div class="mt-4">
            <span class="text-xl font-bold text-blue-600">{{
              sampleStore.sampleCreate.product_srp
            }}</span>
            <span class="ml-2 text-sm text-gray-400 line-through">{{
              sampleStore.sampleCreate.product_final_price
            }}</span>
            <span class="ml-2 text-sm text-red-500">{{
              sampleStore.sampleCreate.product_discount
            }}</span>
          </div>
        </div>
      </div>
